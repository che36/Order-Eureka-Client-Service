...
public class OrderController {
    ...
    public ResponseEntity<Object> getOrdersById(@PathVariable(value = "id") Long orderId)
    ...
    @PutMapping("/order/{id}")
    public ResponseEntity<Object> updateOrder(@PathVariable(value = "id") Long orderId,
